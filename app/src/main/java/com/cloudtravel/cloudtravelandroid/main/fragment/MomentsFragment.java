...
import com.cloudtravel.cloudtravelandroid.main.adapter.MomentItemAdapter;
...
public class MomentsFragment extends CloudTravelBaseFragment {
    ...
    private List<MomentItem> momentItemList=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MomentItemAdapter momentItemAdapter=new MomentItemAdapter(momentItemList);
